...
const localizedValidationMessages = {
  ...
  after: function ({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${s(name)} mora biti posle ${args[0]}.`
    }
    return `${s(name)} mora biti kasniji datum.`
  },
   ...
   */
  alpha: function ({ name }) {
    return `${s(name)} može sadržati samo abecedne karaktere.`
  },
  ...
  alphanumeric: function ({ name }) {
    return `${s(name)} može sadržati samo slova i brojeve.`
  },
  ...
  before: function ({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${s(name)} mora biti pre ${args[0]}.`
    }
    return `${s(name)} mora biti raniji datum.`
  },
  ...
  between: function ({ name, value, args }) {
    ...
    return `${s(name)} mora biti između ${args[0]} i ${args[1]} karaktera.`
  },
  ...
  date: function ({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${s(name)} nije važeći datum, koristite format ${args[0]}`
    }
    return `${s(name)} nije važeći datum.`
  },
  ...
  email: function ({ name, value }) {
    ...
    return `“${value}” nije važeća e-mail adresa.`
  },
  ...
  endsWith: function ({ name, value }) {
    if (!value) {
      return `Ovo polje se ne završava važećom vrednošću.`
    }
    return `“${value}” se ne završava važećom vrednošću.`
  },
  ...
  in: function ({ name, value }) {
    if (typeof value === 'string' && value) {
      return `“${s(value)}” nije dozvoljeno ${name}.`
    }
    return `Ovo nije dozvoljeno ${name}.`
  },
  ...
  max: function ({ name, value, args }) {
    if (Array.isArray(value)) {
      return `Možete odabrati samo ${args[0]} ${name}.`
    }
    const force = Array.isArray(args) && args[1] ? args[1] : false
    if ((!isNaN(value) && force !== 'length') || force === 'value') {
      return `${s(name)} mora biti manje ili jednako ${args[0]}.`
    }
    return `${s(name)} mora biti manje ili jednako ${args[0]} karaktera.`
  },
  ...
  min: function ({ name, value, args }) {
    if (Array.isArray(value)) {
      return `Treba Vam bar ${args[0]} ${name}.`
    }
    const force = Array.isArray(args) && args[1] ? args[1] : false
    if ((!isNaN(value) && force !== 'length') || force === 'value') {
      return `${s(name)} treba da ima najmanje ${args[0]}.`
    }
    return `${s(name)} treba da ima najmanje ${args[0]} karaktera.`
  },
  ...
  startsWith: function ({ name, value }) {
    if (!value) {
      return `Ovo polje ne počinje sa važećom vrednošću.`
    }
    return `“${value}” ne počinje sa važećom vrednošću.`
  },
